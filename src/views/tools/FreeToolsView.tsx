...
const TiltCard: React.FC<TiltCardProps> = ({ children, onClick }) => {
  ...
  return (
    <div
      ...
      className="tilt-card-wrapper relative rounded-2xl bg-white border border-[#E2E8F0] hover:border-[#C9A45C]/40 hover:-translate-y-1 shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_14px_34px_-14px_rgba(15,23,42,0.14)] overflow-hidden transition-all duration-300 cursor-pointer p-6 h-full flex flex-col justify-between space-y-6 group focus:outline-none focus-visible:border-[#C9A45C]/60"
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10 space-y-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#F0FDFA] border border-[#14B8A6]/25 text-[10px] font-extrabold uppercase tracking-[0.25em] text-[#0F766E]">
          ...
          <div className="relative max-w-2xl mx-auto pt-2">
            ...
            />
            {query && (
              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-bold text-[#64748B] uppercase">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        {filtered.length === 0 ? (
          <div className="text-center space-y-4 py-20">
            <SearchIcon className="w-12 h-12 text-[#94A3B8] mx-auto" />
            <p className="text-[#64748B] text-sm">
              No tools match <span className="text-[#111827] font-bold">"{query}"</span> in {activeCategory}.
            </p>
            <button
                ...
                <TiltCard key={t.slug} onClick={() => openTool(t.slug)}>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between gap-2">
                      <span className="text-[10px] font-extrabold text-[#0F766E] uppercase tracking-widest px-2.5 py-1 bg-[#14B8A6]/10 rounded-md border border-[#14B8A6]/25">
                        {t.category}
                      </span>
                      <span className="text-[10px] font-bold text-emerald-700 bg-emerald-500/10 px-2 py-0.5 rounded uppercase whitespace-nowrap">
                        Instant Free
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="shrink-0 w-9 h-9 rounded-lg bg-[#14B8A6]/10 border border-[#14B8A6]/25 flex items-center justify-center mt-0.5">
                        <IconFor name={t.iconName} className="w-[18px] h-[18px] text-[#0F766E] group-hover:text-[#14B8A6] transition-colors" />
                      </div>
                      <h3 className="font-display text-base font-bold text-[#111827] group-hover:text-[#0F766E] transition-colors tracking-tight leading-snug">
                        {t.name}
                      </h3>
                    </div>
                  ...
                  <div className="pt-4 border-t border-[#E2E8F0] flex items-center justify-between text-xs font-bold text-[#334155] group-hover:text-[#0F766E] transition-colors">
                    ...
                    <ArrowRight className="w-4 h-4 text-[#64748B] group-hover:text-[#0F766E] group-hover:translate-x-1 transition-all" />
                  </div>
                </TiltCard>
              ))}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="relative overflow-hidden rounded-3xl border border-[#E2E8F0] bg-gradient-to-br from-white to-[#F0FDFA] p-8 sm:p-12 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
          <div className="absolute -top-24 right-0 w-80 h-80 bg-[#14B8A6]/10 blur-[100px] rounded-full pointer-events-none" />
          <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="space-y-3 max-w-xl">
              <div className="inline-flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-[0.25em] text-[#0F766E]">
                <SmartphoneIcon className="w-4 h-4" /> Progressive Web App
              </div>
              <h2 className="font-display text-2xl font-extrabold text-[#111827] tracking-tight">Get Branify on your Mobile &amp; Desktop device</h2>
