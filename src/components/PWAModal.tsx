...
export const PWAModal: React.FC<PWAModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg rounded-2xl bg-[#0F1015] border border-[#D4AF37]/30 shadow-[0_0_50px_rgba(212,175,55,0.15)] p-6 sm:p-8 text-[#F1F2EE] space-y-6"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-5 right-5 p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 text-[#F1F2EE]/70 hover:text-[#F1F2EE] transition-colors"
        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#E5C378] to-[#997A15] p-[1px] shadow-[0_0_25px_rgba(212,175,55,0.3)]">
            <div className="w-full h-full bg-[#05080D] rounded-[11px] flex items-center justify-center">
        ...
        <p className="text-xs text-[#F1F2EE]/70 leading-relaxed font-light">
        ...
        <div className="space-y-4 pt-2 border-t border-white/10">
          ...
          {isIOS ? (
            <div className="space-y-3 text-xs text-[#F1F2EE]/80">
              <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                ...
                <div>
                  <span className="font-semibold text-[#F1F2EE]">1. Tap the Share button</span>
                  <p className="text-[11px] text-[#F1F2EE]/50">Located in the bottom Safari navigation bar.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                ...
                <div>
                  <span className="font-semibold text-[#F1F2EE]">2. Select &ldquo;Add to Home Screen&rdquo;</span>
                  <p className="text-[11px] text-[#F1F2EE]/50">Scroll down in the action menu to find the icon.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                ...
                <div>
                  <span className="font-semibold text-[#F1F2EE]">3. Confirm &ldquo;Add&rdquo;</span>
                  <p className="text-[11px] text-[#F1F2EE]/50">The Branify emblem will appear on your home screen.</p>
                </div>
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-[#F1F2EE]/80">
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/5 space-y-1.5">
                <div className="flex items-center gap-2 text-[#F1F2EE] font-semibold">
                  <Laptop className="w-4 h-4 text-[#D4AF37]" />
                  <span>Desktop Chrome / Edge</span>
                </div>
                <p className="text-[11px] text-[#F1F2EE]/50 leading-relaxed">
        ...
        {/* Benefits Row */}
        <div className="flex items-center justify-between pt-2 text-[11px] text-[#F1F2EE]/40 border-t border-white/5 font-mono">
