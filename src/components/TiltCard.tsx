  ...
  return (
    <div className="perspective-1200 w-full">
      <div
        ...
        className={`tilt-card-wrapper preserve-3d relative rounded-2xl bg-[#080B14]/85 backdrop-blur-xl border border-white/[0.08] hover:border-violet-500/40 shadow-xl shadow-black/60 overflow-hidden transition-all duration-300 ${onClick ? 'cursor-pointer' : ''} ${className}`}
