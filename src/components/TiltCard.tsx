  ...
  return (
    <div className="perspective-1200 w-full">
      <div
        ...
        className={`tilt-card-wrapper preserve-3d relative rounded-2xl bg-white border border-[#E2E8F0] shadow-[0_1px_2px_rgba(15,23,42,0.04)] hover:shadow-[0_14px_34px_-14px_rgba(15,23,42,0.14)] hover:border-[#C9A45C]/40 overflow-hidden transition-all duration-300 ${onClick ? 'cursor-pointer' : ''} ${className}`}
